...
public class VolunteerProfileController {
    ...
    public ResponseMessage getVolunteerInfo(final HttpServletRequest request) throws Exception{
    ...
    public ResponseMessage updateVolunteerInfos(final HttpServletRequest request, final @RequestBody VolunteerDTO volunteer) throws Exception{
        String email = this.userVerify.validateUserRoleFromToken(request, UserRole.volunteer);

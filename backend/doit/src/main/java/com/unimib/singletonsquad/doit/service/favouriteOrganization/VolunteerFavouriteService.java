...
public class VolunteerFavouriteService {
    ...
    public void addFavouriteOrganization(String email, String organizationName) throws Exception {
    ...
    public void revokeFavouriteOrganization(String email, String organizationName) throws Exception {
    ...
    public List<OrganizationDTO> getFavouriteOrganizations(String email) throws Exception {
        Volunteer volunteer = this.volunteerDatabaseService.findVolunteerByEmail(email);
